...
<xsl:stylesheet xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.openarchives.org/OAI/2.0/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" xsi:schemaLocation="http://www.openarchives.org/OAI/2.0/ http://www.openarchives.org/OAI/2.0/OAI-PMH.xsd" exclude-result-prefixes="marc">
  ...
  <xsl:param name="xml_file_name" select="concat($root,'/','ebooks/files/cairn_qsj_',.substring(string(current-date()), 1, 10),'.xml')"/>
      ...
      <OAI-PMH xmlns="http://www.openarchives.org/OAI/2.0/" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:schemaLocation="http://www.openarchives.org/OAI/2.0/ http://www.openarchives.org/OAI/2.0/OAI-PMH.xsd">
        <ListRecords>
          <xsl:for-each select="marc:record">
            ...
            <record>
              <header>
                <identifier><xsl:value-of select="$provider"/>-publish:<xsl:value-of select="$id"/></identifier>
              </header>
              <metadata>
                <record>
                  <leader>
                  ...
                  <xsl:call-template name="url">
                    <xsl:with-param name="url_path" select="marc:datafield[@tag='856']/marc:subfield[@code='u']"/>
                  </xsl:call-template>
  ...
  <xsl:template name="url">
    ...
    <datafield tag="856" ind1="4" ind2=" ">
      <subfield code="u">
        <xsl:value-of select="concat('http://proxy.unice.fr/login?url=',$url_path)"/>
      </subfield>
    </datafield>
  </xsl:template>
