...
<xsl:stylesheet xmlns:marc="http://www.loc.gov/MARC21/slim" version="2.0"
  ...
  <xsl:param name="xml_file_name" select="concat($root,'/','ebooks/files/cairn_titres_',.substring(string(current-date()), 1, 10),'.xml')"/>
